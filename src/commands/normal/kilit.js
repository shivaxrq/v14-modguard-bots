...
const { ActionRowBuilder, ButtonBuilder, PermissionsBitField, ButtonStyle, EmbedBuilder } = require('discord.js');
...
module.exports = {
  ...
  run: async (client, message, args) => {  
    ...
    .setColor(0x2B2D31)  
    .setDescription(`${message.author} Kanal Kilidini Aktifleştirmek ve Deaktifleştirmek için butonları kullanınız. Gereksiz kullanımda Ancient ile görüşmeniz sorun yaratabilir.`)
